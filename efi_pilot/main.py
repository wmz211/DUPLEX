...
def main():
    ...
    # API Keys
    parser.add_argument('--deepseek-key', default='<REMOVED_API_KEY>')
    parser.add_argument('--bocha-key',    default='<REMOVED_API_KEY>')
    parser.add_argument('--qwen-key',     default='<REMOVED_API_KEY>')
    ...
    parser.add_argument('--workers',   type=int, default=3,
                        help='HD 并行线程数（建议 3-5）')
    parser.add_argument('--log-mode',  choices=['r', 'o'], default='r',
                        help='日志模式: r=实时 / o=按序')
